...
def _calculate_a(planets : list[Planet], 
                 i : int, 
                 j : int) -> ntp.NDArray[np.float64]:
    """
    Функция вычисления ускорения планеты по расстояниям между ней и другими планетами.
...
def _calculate_up(planets : list[Planet], 
                  i : int, 
                  j : int) -> float:
    """
    Функция вычисления потенциальной энергии планеты по расстояниям между ней и другими планетами.
...
def _calculate_uk(planets : list[Planet], 
                  i : int, 
                  j : int) -> float:
    """
    Функция вычисления кинетической энергии планеты по её скорости.
...
@_init_euler
def calculate_euler(planets : list[Planet], 
                    start_pos : int, 
                    size : int, 
                    ht : int):
    """
    Функция вычисления перемещения планет методом Эйлера.
...
@_init_euler
def calculate_eulkram(planets : list[Planet], 
                      start_pos : int, 
                      size : int, 
                      ht : int):
    """
    Функция вычисления перемещения планет методом Эйлера-Крамера.
...
@_init_biman
def calculate_biman(planets : list[Planet], 
                    start_pos : int, 
                    size : int, 
                    ht : int):
    """
    Функция вычисления перемещения планет методом Бимана.
...
@_init_vernel
def calculate_vernel(planets : list[Planet], 
                     start_pos : int, 
                     size : int, 
                     ht : int):
    """
    Функция вычисления перемещения планет методом Вернеле.
